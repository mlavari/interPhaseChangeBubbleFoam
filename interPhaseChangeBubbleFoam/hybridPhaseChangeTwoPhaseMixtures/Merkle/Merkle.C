...
namespace hybridPhaseChangeTwoPhaseMixtures
{
    ...
    addToRunTimeSelectionTable(hybridPhaseChangeTwoPhaseMixture, Merkle, components);
}
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::hybridPhaseChangeTwoPhaseMixtures::Merkle::Merkle
(
...
:
    ...
    UInf_("UInf", dimVelocity, hybridPhaseChangeTwoPhaseMixtureCoeffs_),
    tInf_("tInf", dimTime, hybridPhaseChangeTwoPhaseMixtureCoeffs_),
...
Foam::hybridPhaseChangeTwoPhaseMixtures::Merkle::mDotAlphal() const
{
...
Foam::Pair<Foam::tmp<Foam::volScalarField>>
Foam::hybridPhaseChangeTwoPhaseMixtures::Merkle::mDotP() const
{
    const volScalarField& p = alpha1_.db().lookupObject<volScalarField>("p");
...
void Foam::hybridPhaseChangeTwoPhaseMixtures::Merkle::correct()
{}


bool Foam::hybridPhaseChangeTwoPhaseMixtures::Merkle::read()
{
    if (hybridPhaseChangeTwoPhaseMixture::read())
    {
        hybridPhaseChangeTwoPhaseMixtureCoeffs_ = optionalSubDict(type() + "Coeffs");

        hybridPhaseChangeTwoPhaseMixtureCoeffs_.readEntry("UInf", UInf_);
        hybridPhaseChangeTwoPhaseMixtureCoeffs_.readEntry("tInf", tInf_);
