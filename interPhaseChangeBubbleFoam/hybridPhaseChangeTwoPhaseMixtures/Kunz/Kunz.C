...
namespace hybridPhaseChangeTwoPhaseMixtures
{
    ...
    addToRunTimeSelectionTable(hybridPhaseChangeTwoPhaseMixture, Kunz, components);
}
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::hybridPhaseChangeTwoPhaseMixtures::Kunz::Kunz
(
...
Foam::hybridPhaseChangeTwoPhaseMixtures::Kunz::mDotAlphal() const
{
...
Foam::Pair<Foam::tmp<Foam::volScalarField>>
Foam::hybridPhaseChangeTwoPhaseMixtures::Kunz::mDotP() const
{
    const volScalarField& p = alpha1_.db().lookupObject<volScalarField>("p");
    volScalarField limitedAlpha1(clamp(alpha1_, zero_one{}));
...
void Foam::hybridPhaseChangeTwoPhaseMixtures::Kunz::correct()
{}


bool Foam::hybridPhaseChangeTwoPhaseMixtures::Kunz::read()
{
